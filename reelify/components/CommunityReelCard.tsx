...
const CommunityReelCard = (props: { username: any; description: any; imgLink: any; videoLink: any; promptText: any; }) => {    
        ...
        <div className="flex justify-between items-start flex-grow">
          <div className="pl-3 flex flex-col justify-start items-start flex-grow">
            ...
            <div className="flex justify-start items-center w-full">
              <div className="w-2/5 pt-3 pb-3 pr-5" onMouseEnter={() => setIsPlaying(true)} onMouseLeave = {() => setIsPlaying(false)}>
              <ReactPlayer loop={true} controls={true} playing={isPlaying} width={"300px"} height={"400px"} url={videoLink}/>              
              </div>
